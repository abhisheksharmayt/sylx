import {html, css, bootstrap, tailwindCss, reactjs, nodejs, expressjs, mongodb, javascript} from '@/components/svg-icons/svg';
...
export const projectsData = [
    {
        ...
        img: "/images/projects_thumbnail/techBeats.png",
        duties: [],
        tech_stack:[
            {
                id: '1a',
    ...
    },
    {
        ...
        img: "/images/projects_thumbnail/tesla.png",
        duties: [
    ...
    },
    {
        ...
        img: "/images/projects_thumbnail/reactMovie.png",
        duties: [
            "Full C.R.U.D website where user can add their campus, and other users can interact by adding their reviews about campuses.",
            "Added authentication and error-handling.",
        ],
    ...
    },
    {
        ...
        img: "/images/projects_thumbnail/campusTour.png",
        duties: [
    ...
    },
    {
        ...
        img: "/images/projects_thumbnail/sorting.png",
        duties: [
            "Shows working of Bubble Sort, Insertion Sort, Selection Sort and Merge Sort by visualizing them.",
        ],
        tech_stack: [
    ...
    },
    {
        ...
        img: "/images/projects_thumbnail/sudoku.png",
        duties: [
            "Shows working of Bubble Sort, Insertion Sort, Selection Sort and Merge Sort by visualizing them.",
        ],
        tech_stack: [
